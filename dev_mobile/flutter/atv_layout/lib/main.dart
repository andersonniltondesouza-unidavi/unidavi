...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const String appTitle = 'Atividade Layout Flutter';
    return MaterialApp(
      title: appTitle,
      home: Scaffold(
        ...
        body: const SingleChildScrollView(
          child: Column(
            children: [
              ImageSection(image: 'images/incendio.jpg'),
              TitleSection(
                name: 'Incêndio em Laurentino',
                location: 'Laurentino - SC, Brasil',
              ),
              ButtonSection(),
              TextSection(
                description:
                    'Incêndio próximo a academia Bem Estar Fit em Laurentino',
              ),
            ],
          ),
        ),
    ...
    return SizedBox(
      child: Row(
        ...
        children: [
          ...
          ButtonWithText(color: color, icon: Icons.near_me, label: 'ROTAS'),
